...
function ach(
  ...
  return {
    ...
    // Прогрес показуємо лише для ще не вибитих накопичувальних ачивок.
    progress: !unlocked && progress ? progress : null,
  };
}
...
const achievementsByApp: Record<number, Ach[]> = {
  1091500: [
    ...
    ach("cp_legend", "Легенда Найт-Сіті", "Завершити всі сюжетні лінії.", 8.1, false, { current: 2, target: 3 }),
    ach("cp_max", "Максимальний рівень", "Прокачати всі атрибути до 20.", 3.7, false, { current: 14, target: 20 }),
  ...
  292030: [
    ...
    ach("w3_full", "Повна колекція", "Зібрати всі спорядження школи.", 6.3, false, { current: 4, target: 6 }),
  ...
  1245620: [
    ...
    ach("er_shard", "Господар осколка", "Здобути другий великий осколок.", 29.4, false, { current: 1, target: 2 }),
    ach("er_lord", "Повелитель Ельдену", "Завершити гру.", 24.1, false),
    ach("er_all", "Легендарне спорядження", "Зібрати всі легендарні предмети.", 3.4, false, { current: 7, target: 12 }),
  ...
  105600: [
    ...
    ach("tr_moon", "Володар Місяця", "Перемогти Володаря Місяця.", 9.8, false, { current: 3, target: 8 }),
  ],
  413150: [
